    ...
    public class ContentTypeEnricherTests
    {
        ...
        public void SetUp()
        {
            ...
            _logger = new LoggerConfiguration()
                .Enrich.With(new ContentTypeEnricher(_httpContextProvider.Object))
        ...
        public void ShouldCreateContentTypeProperty()
        {
            ...
            _httpRequestWrapper.SetupGet(x => x.ContentType).Returns(expected);
            ...
            Assert.AreEqual($"\"{expected}\"", _logEvent.Properties["ContentType"].LiteralValue());
        }
    }
}