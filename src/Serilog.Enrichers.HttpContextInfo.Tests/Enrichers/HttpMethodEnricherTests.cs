...
namespace Serilog.Tests.Enrichers
{
    [TestFixture]
    [Parallelizable]
    public class HttpMethodEnricherTests
    {
        [SetUp]
        public void SetUp()
        {
            ...
            _logger = new LoggerConfiguration()
                .Enrich.With(new HttpMethodEnricher(_httpContextProvider.Object))
        ...
        public void ShouldCreateHttpMethodProperty()
        {
            ...
            _httpRequestWrapper.SetupGet(x => x.HttpMethod).Returns(expected);
            ...
            Assert.AreEqual($"\"{expected}\"", _logEvent.Properties["HttpMethod"].LiteralValue());
        }
    }
}