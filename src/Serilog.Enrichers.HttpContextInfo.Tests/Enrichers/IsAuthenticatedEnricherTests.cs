...
namespace Serilog.Tests.Enrichers
{
    [TestFixture]
    [Parallelizable]
    public class IsAuthenticatedEnricherTests
    {
        [SetUp]
        public void SetUp()
        {
            ...
            _logger = new LoggerConfiguration()
                .Enrich.With(new IsAuthenticatedEnricher(_httpContextProvider.Object))
        ...
        public void ShouldCreateIsAuthenticatedProperty()
        {
            ...
            _httpRequestWrapper.SetupGet(x => x.IsAuthenticated).Returns(expected);
            ...
            Assert.AreEqual($"{expected}", _logEvent.Properties["IsAuthenticated"].LiteralValue());
        }
    }
}