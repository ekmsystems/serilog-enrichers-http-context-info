...
namespace Serilog.Tests.Enrichers
{
    [TestFixture]
    [Parallelizable]
    public class IsLocalEnricherTests
    {
        [SetUp]
        public void SetUp()
        {
            ...
            _logger = new LoggerConfiguration()
                .Enrich.With(new IsLocalEnricher(_httpContextProvider.Object))
        ...
        public void ShouldCreateIsLocalProperty()
        {
            ...
            _httpRequestWrapper.SetupGet(x => x.IsLocal).Returns(expected);
            ...
            Assert.AreEqual($"{expected}", _logEvent.Properties["IsLocal"].LiteralValue());
        }
    }
}