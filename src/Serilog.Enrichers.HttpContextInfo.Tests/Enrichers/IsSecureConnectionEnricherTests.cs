...
namespace Serilog.Tests.Enrichers
{
    [TestFixture]
    [Parallelizable]
    public class IsSecureConnectionEnricherTests
    {
        [SetUp]
        public void SetUp()
        {
            ...
            _logger = new LoggerConfiguration()
                .Enrich.With(new IsSecureConnectionEnricher(_httpContextProvider.Object))
        ...
        public void ShouldCreateIsSecureConnectionProperty()
        {
            ...
            _httpRequestWrapper.SetupGet(x => x.IsSecureConnection).Returns(expected);
            ...
            Assert.AreEqual($"{expected}", _logEvent.Properties["IsSecureConnection"].LiteralValue());
        }
    }
}