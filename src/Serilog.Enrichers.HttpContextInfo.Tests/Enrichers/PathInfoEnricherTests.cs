...
namespace Serilog.Tests.Enrichers
{
    [TestFixture]
    [Parallelizable]
    public class PathInfoEnricherTests
    {
        [SetUp]
        public void SetUp()
        {
            ...
            _logger = new LoggerConfiguration()
                .Enrich.With(new PathInfoEnricher(_httpContextProvider.Object))
        ...
        public void ShouldCreatePathInfoProperty()
        {
            ...
            _httpRequestWrapper.SetupGet(x => x.PathInfo).Returns(expected);
            ...
            Assert.AreEqual($"\"{expected}\"", _logEvent.Properties["PathInfo"].LiteralValue());
        }
    }
}