...
namespace Serilog.Tests.Enrichers
{
    [TestFixture]
    [Parallelizable]
    public class PhysicalPathEnricherTests
    {
        [SetUp]
        public void SetUp()
        {
            ...
            _logger = new LoggerConfiguration()
                .Enrich.With(new PhysicalPathEnricher(_httpContextProvider.Object))
        ...
        public void ShouldCreatePhysicalPathProperty()
        {
            ...
            _httpRequestWrapper.SetupGet(x => x.PhysicalPath).Returns(expected);
            ...
            Assert.AreEqual($"\"{expected}\"", _logEvent.Properties["PhysicalPath"].LiteralValue());
        }
    }
}