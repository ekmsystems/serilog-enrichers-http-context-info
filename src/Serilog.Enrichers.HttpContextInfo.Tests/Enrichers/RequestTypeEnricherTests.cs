...
namespace Serilog.Tests.Enrichers
{
    [TestFixture]
    [Parallelizable]
    public class RequestTypeEnricherTests
    {
        [SetUp]
        public void SetUp()
        {
            ...
            _logger = new LoggerConfiguration()
                .Enrich.With(new RequestTypeEnricher(_httpContextProvider.Object))
        ...
        public void ShouldCreateRequestTypeProperty()
        {
            ...
            _httpRequestWrapper.SetupGet(x => x.RequestType).Returns(expected);
            ...
            Assert.AreEqual($"\"{expected}\"", _logEvent.Properties["RequestType"].LiteralValue());
        }
    }
}