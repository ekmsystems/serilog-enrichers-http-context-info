...
namespace Serilog.Tests.Enrichers
{
    [TestFixture]
    [Parallelizable]
    public class UserAgentEnricherTests
    {
        [SetUp]
        public void SetUp()
        {
            ...
            _logger = new LoggerConfiguration()
                .Enrich.With(new UserAgentEnricher(_httpContextProvider.Object))
        ...
        public void ShouldCreateUserAgentProperty()
        {
            ...
            _httpRequestWrapper.SetupGet(x => x.UserAgent).Returns(expected);
            ...
            Assert.AreEqual($"\"{expected}\"", _logEvent.Properties["UserAgent"].LiteralValue());
        }
    }
}