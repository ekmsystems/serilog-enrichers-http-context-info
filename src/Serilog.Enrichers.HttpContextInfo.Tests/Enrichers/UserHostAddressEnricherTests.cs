...
namespace Serilog.Tests.Enrichers
{
    [TestFixture]
    [Parallelizable]
    public class UserHostAddressEnricherTests
    {
        [SetUp]
        public void SetUp()
        {
            ...
            _logger = new LoggerConfiguration()
                .Enrich.With(new UserHostAddressEnricher(_httpContextProvider.Object))
        ...
        public void ShouldCreateUserHostAddressProperty()
        {
            ...
            _httpRequestWrapper.SetupGet(x => x.UserHostAddress).Returns(expected);
            ...
            Assert.AreEqual($"\"{expected}\"", _logEvent.Properties["UserHostAddress"].LiteralValue());
        }
    }
}